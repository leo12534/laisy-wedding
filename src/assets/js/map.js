...
async function initMapB() {
  // The location of Hilton Garden Inn Roslyn

  const position = { lat: 40.80857202671781, lng: -73.6572417480127 };
  ...
  // The marker, positioned at Hilton Garden Inn Roslyn
  ...
  new google.maps.Marker({
    position: position,
    title: 'Hilton Garden Inn Roslyn',
    // icon: svgMarker,
    map: map,
  });
